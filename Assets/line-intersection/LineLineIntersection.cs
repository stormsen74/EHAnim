    ...
    public class LineLineIntersection : MonoBehaviour {
        ...
        void Update() {
            ...
            if (IsIntersecting()) {
                ...
                Vector2 pos = new Vector2(L1_end.position.x, L1_end.position.z);

                Debug.Log("" + Vector2.Distance(pos, intersectPoint));

                Cross.transform.position = new Vector3(intersectPoint.x, 0f, intersectPoint.y);
            }
